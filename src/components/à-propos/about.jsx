    ...
    <div className="about-page">
      ...
      <section className="about-hero">
        <div className="content">
          ...
          <p>
            MedLife est une plateforme web complète qui révolutionne la gestion des cliniques et cabinets médicaux.
          </p>
        </div>
      </section>
    ...
    <div className="value-card">
      ...
      <section className="about-team">
        ...
        <p>
          ...
          dédiée à améliorer l'expérience médicale numérique et à faciliter la vie des patients comme des praticiens.
        </p>
      </section>
